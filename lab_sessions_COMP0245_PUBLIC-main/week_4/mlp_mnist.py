...
activations = ['Relu','Sigmoid','CrossEntropyLoss']
...
train_dataset = datasets.MNIST(root='./245/4/data', train=True,
                               transform=transform, download=True)
test_dataset = datasets.MNIST(root='./245/4/data', train=False,
                              transform=transform, download=True)
...
plt.plot(range(epochs),train_losses,"b",label = "Train_Loss")
figure = plt.figure(1)
plt.title("Accuracy by Epoch")
plt.plot(range(epochs),train_accuracies,"b",label = "Train_Accuracy")
