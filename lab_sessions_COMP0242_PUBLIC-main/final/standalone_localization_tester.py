...
from robot_localization_system import FilterConfiguration, Map, RobotEstimator_R, RobotEstimator_RB
...
class Simulator(object):
    ...
    # TODO Get the Range_Bearing observations to the landmarks. Return None if none visible
...
for step in range(sim_config.time_steps):
    ...
    if sensor_type == "R":
        ...
        y_range,y_bearing = simulator.landmark_range_bearing_observations()
